...
public:
    ...
    void setupUi(QDialog *MyDialog)
    {
        ...
        MyDialog->resize(1000, 400);
        frame = new QFrame(MyDialog);
        frame->setObjectName(QStringLiteral("frame"));
        frame->setGeometry(QRect(20, 170, 961, 121));
        frame->setFrameShape(QFrame::StyledPanel);
        frame->setFrameShadow(QFrame::Raised);
        gridLayoutWidget = new QWidget(frame);
        gridLayoutWidget->setObjectName(QStringLiteral("gridLayoutWidget"));
        gridLayoutWidget->setGeometry(QRect(10, 10, 941, 101));
        ...
        horizontalLayoutWidget_3->setGeometry(QRect(810, 300, 171, 41));
        ...
        verticalLayoutWidget->setGeometry(QRect(20, 10, 961, 151));
        ...
        label_8->setGeometry(QRect(20, 250, 441, 21));
